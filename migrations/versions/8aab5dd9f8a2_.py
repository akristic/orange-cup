...
Revision ID: 8aab5dd9f8a2
Revises: 
Create Date: 2020-04-23 19:59:24.167107
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('settings_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('number_of_games_to_win', sa.INTEGER(), autoincrement=False, nullable=False),
