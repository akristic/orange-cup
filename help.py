  ...
  def get_players():
    ...
    def create_player():
        ...
        if error:
            ...
            return jsonify({
            'success': True,
            'match': newPlayer.format(),
            'total_players': len(Players.query.all())
            })
    ...
    def create_settings():
      ...
      try:
          data = json.loads(request.data.decode('utf-8'))
          number_of_gamest_to_win = data['number_of_gamest_to_win']
          ...
          newSettings = Settings(
            number_of_gamest_to_win=number_of_gamest_to_win,
